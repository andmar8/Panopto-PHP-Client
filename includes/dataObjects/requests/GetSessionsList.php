<?php
     ...
     * 
     */
    require_once(dirname(__FILE__)."/listModifier/ListSessionsRequest.php");
...
class GetSessionsList
{
    ...
    public function __construct($auth,$listSessionsRequest,$searchQuery)
    {
        $this->auth = $auth;
        $this->request = $listSessionsRequest;
