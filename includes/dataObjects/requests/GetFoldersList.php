<?php
     ...
     * 
     */
    require_once(dirname(__FILE__)."/listModifier/ListFoldersRequest.php");
...
class GetFoldersList
{
    ...
    public function __construct($auth,$listFoldersRequest,$searchQuery)
    {
        $this->auth = $auth;
        $this->request = $listFoldersRequest;
