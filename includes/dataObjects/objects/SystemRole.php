...
class SystemRole
{
    ...
    public static function getSystemRoleFromSystemRoleName($systemRoleString)
    {
        switch($systemRoleString)
        {
            case "None": return SystemRole::None;
            case "Videographer": return SystemRole::Videographer;
