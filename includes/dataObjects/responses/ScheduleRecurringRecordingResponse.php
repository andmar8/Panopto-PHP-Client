...
class ScheduleRecurringRecordingResponse
{
    ...
    public function __construct($scheduleRecurringRecordingResult, $originalSessionId = NULL)
    {
        $this->guids = new ArrayofGuid($scheduleRecurringRecordingResult->ScheduleRecuringRecordingResult);
        if(isset($originalSessionId)){$this->guids->addAGuid($originalSessionId);}
    }
