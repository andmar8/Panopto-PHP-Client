...
class ArrayOfRemoteRecorder
{
    private $remoteRecorders = array();
    
    public function __construct($remoteRecorders)
    {
        $this->remoteRecorders = $remoteRecorders;
    }

    public function getRemoteRecorders()
    {
        return $this->remoteRecorders;
    }

    public function setRemoteRecorders($remoteRecorders)
    {
        $this->remoteRecorders = $remoteRecorders;
    }
}
